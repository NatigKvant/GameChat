...
import {getMessageFromServer, setMessages, addMessageFromUser} from '../../../../../Redux/generalChat-reducer'
...
const GeneralChat: FC<{}> = () => {

    const dispatch = useDispatch()
    const messages = useSelector((state: AppStateType) => state.GeneralChatReducer.messages)

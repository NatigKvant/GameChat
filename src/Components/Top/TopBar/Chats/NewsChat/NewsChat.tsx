...
import {getMessageFromServer, setMessages, addMessageFromUser} from '../../../../../Redux/newsChat-reducer'
...
const NewsChat: FC<{}> = () => {
    ...
    const messages = useSelector((state: AppStateType) => state.NewsChatReducer.messages)
